 ...
 */
public class FilterItemEvenAdapter extends ArrayAdapter<String> {

    private String[] values;
    private LayoutInflater layoutInflater;

    public FilterItemEvenAdapter(Context context, int resource, String[] objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                break;
            case 2:
                colorFill = Color.rgb(38, 183, 154);
                colorStro = Color.rgb(0, 133, 104);
